...
public class ControladorPrincipal {
    ...
    private VBox crearBarraLateral() {
        VBox barra = new VBox(15);
        barra.setStyle("-fx-background-color: #2c3e50;");
        barra.setPadding(new Insets(20, 15, 20, 15));
        barra.setMinWidth(250);
        barra.setMaxWidth(250);
        ...
        barra.getChildren().addAll(nombreUsuario, rolUsuario, new Separator());
        ...
        barra.getChildren().addAll(btnInventario, btnUsuarios, btnEstadisticas, btnFormularios, btnSolicitudes, new Separator());

        Button btnConfig = crearBotonMenu("Configuracion", e -> mostrarVistaConfiguracion());
        Button btnCerrarSesion = crearBotonCerrarSesion();

        barra.getChildren().addAll(btnConfig, btnCerrarSesion);
