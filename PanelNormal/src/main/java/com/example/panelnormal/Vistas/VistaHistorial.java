...
public class VistaHistorial {
    ...
    public VistaHistorial(Runnable onBackAction) {
        ...
        // Mensaje principal
        Label titulo = new Label("No hay datos registrados");
        titulo.setFont(Font.font("Arial", FontWeight.BOLD, 24));
        titulo.setTextFill(Color.web("#7f8c8d"));

        // Mensaje secundario
        Label subtitulo = new Label("El sistema no tiene historial actualmente");
